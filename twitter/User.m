...
- (id) initWithDictionary:(NSDictionary *)dictionary {
    ...
    if (self) {
        ...
        self.noOfTweets = [dictionary[@"statuses_count"] integerValue];
        self.noOfFollowing = [dictionary[@"friends_count"] integerValue];
        self.noOfFollowers = [dictionary[@"followers_count"] integerValue];
    }
    return  self;
}
